...
#  define CA_MAX_DRAW_CMDS_PER_WINDOW 16384
#endif
...
#  define CA_MAX_LABELS_PER_WINDOW 8192
#endif
#ifndef CA_MAX_BUTTONS_PER_WINDOW
#  define CA_MAX_BUTTONS_PER_WINDOW 4096
#endif
#ifndef CA_MAX_INPUTS_PER_WINDOW
#  define CA_MAX_INPUTS_PER_WINDOW 512
#endif
#ifndef CA_MAX_CHECKBOXES_PER_WINDOW
#  define CA_MAX_CHECKBOXES_PER_WINDOW 512
#endif
#ifndef CA_MAX_RADIOS_PER_WINDOW
#  define CA_MAX_RADIOS_PER_WINDOW 512
#endif
#ifndef CA_MAX_SLIDERS_PER_WINDOW
#  define CA_MAX_SLIDERS_PER_WINDOW 256
#endif
#ifndef CA_MAX_TOGGLES_PER_WINDOW
#  define CA_MAX_TOGGLES_PER_WINDOW 256
#endif
#ifndef CA_MAX_PROGRESS_PER_WINDOW
#  define CA_MAX_PROGRESS_PER_WINDOW 256
#endif
#ifndef CA_MAX_SELECTS_PER_WINDOW
#  define CA_MAX_SELECTS_PER_WINDOW 128
#endif
#ifndef CA_MAX_TABBARS_PER_WINDOW
#  define CA_MAX_TABBARS_PER_WINDOW 64
#endif
#ifndef CA_MAX_TREENODES_PER_WINDOW
#  define CA_MAX_TREENODES_PER_WINDOW 8192
#endif
#ifndef CA_MAX_TABLES_PER_WINDOW
#  define CA_MAX_TABLES_PER_WINDOW 64
#endif
#ifndef CA_MAX_TOOLTIPS_PER_WINDOW
#  define CA_MAX_TOOLTIPS_PER_WINDOW 4096
#endif
