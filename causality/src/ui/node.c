...
bool content_desc_changed(const Ca_NodeDesc *a, const Ca_NodeDesc *b)
{
    return a->background      != b->background      ||
           ...
           a->scrollbar_track_border_width != b->scrollbar_track_border_width ||
           a->scrollbar_track_border_top_color != b->scrollbar_track_border_top_color ||
           a->scrollbar_track_border_right_color != b->scrollbar_track_border_right_color ||
           a->scrollbar_track_border_bottom_color != b->scrollbar_track_border_bottom_color ||
           a->scrollbar_track_border_left_color != b->scrollbar_track_border_left_color ||
           a->scrollbar_thumb_border_width != b->scrollbar_thumb_border_width ||
           a->scrollbar_thumb_border_top_color != b->scrollbar_thumb_border_top_color ||
           a->scrollbar_thumb_border_right_color != b->scrollbar_thumb_border_right_color ||
           a->scrollbar_thumb_border_bottom_color != b->scrollbar_thumb_border_bottom_color ||
           a->scrollbar_thumb_border_left_color != b->scrollbar_thumb_border_left_color ||
           a->scrollbar_width_set != b->scrollbar_width_set ||
           ...
           a->scrollbar_track_border_width_set != b->scrollbar_track_border_width_set ||
           a->scrollbar_track_border_top_color_set != b->scrollbar_track_border_top_color_set ||
           a->scrollbar_track_border_right_color_set != b->scrollbar_track_border_right_color_set ||
           a->scrollbar_track_border_bottom_color_set != b->scrollbar_track_border_bottom_color_set ||
           a->scrollbar_track_border_left_color_set != b->scrollbar_track_border_left_color_set ||
           a->scrollbar_thumb_border_width_set != b->scrollbar_thumb_border_width_set ||
           a->scrollbar_thumb_border_top_color_set != b->scrollbar_thumb_border_top_color_set ||
           a->scrollbar_thumb_border_right_color_set != b->scrollbar_thumb_border_right_color_set ||
           a->scrollbar_thumb_border_bottom_color_set != b->scrollbar_thumb_border_bottom_color_set ||
           a->scrollbar_thumb_border_left_color_set != b->scrollbar_thumb_border_left_color_set ||
