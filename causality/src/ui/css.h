...
typedef enum {
    ...
    CA_CSS_PROP_SCROLLBAR_TRACK_BORDER_WIDTH,
    CA_CSS_PROP_SCROLLBAR_TRACK_BORDER_TOP_COLOR,
    CA_CSS_PROP_SCROLLBAR_TRACK_BORDER_RIGHT_COLOR,
    CA_CSS_PROP_SCROLLBAR_TRACK_BORDER_BOTTOM_COLOR,
    CA_CSS_PROP_SCROLLBAR_TRACK_BORDER_LEFT_COLOR,
    CA_CSS_PROP_SCROLLBAR_THUMB_BORDER_WIDTH,
    CA_CSS_PROP_SCROLLBAR_THUMB_BORDER_TOP_COLOR,
    CA_CSS_PROP_SCROLLBAR_THUMB_BORDER_RIGHT_COLOR,
    CA_CSS_PROP_SCROLLBAR_THUMB_BORDER_BOTTOM_COLOR,
    CA_CSS_PROP_SCROLLBAR_THUMB_BORDER_LEFT_COLOR,
